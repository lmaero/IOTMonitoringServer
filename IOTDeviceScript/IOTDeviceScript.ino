...
const char ssid[] = "FamiliaGuzman";  // TODO cambiar por el nombre de la red WiFi
// Contraseña de la red WiFi
const char pass[] = "901127Packers!";  // TODO cambiar por la contraseña de la red WiFi
...
const char MQTT_HOST[] = "34.238.252.110";  // TODO Reemplace ip.maquina.mqtt por la IP del bróker MQTT que usted desplegó. Ej: 192.168.0.1
...
const char MQTT_TOPIC_PUB[] = "colombia/cundinamarca/zipaquira/" USER "/out";  //TODO Reemplace el valor por el tópico de publicación que le corresponde.
// El tópico de suscripción debe tener estructura: <país>/<estado>/<ciudad>/<usuario>/in
const char MQTT_TOPIC_SUB[] = "colombia/cundinamarca/zipaquira/" USER "/in";  //TODO Reemplace el valor por el tópico de suscripción que le corresponde.
...
void receivedCallback(char* topic, byte* payload, unsigned int length) {
  ...
  Serial.print(data);
  if (data.indexOf("AVG_VALUE") >= 0) {
    display.clearDisplay();
    display.setCursor(0, 0);
    data = String(data).substring(0, 17);
    displayMessage(data);
    display.display();
    delay(5000);
  }
